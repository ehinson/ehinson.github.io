export const workHistory = [
  {
    years: "2020 - present",
    employer: "MUSICBED",
    title: "SOFTWARE ENGINEER -- FRONT END APPLICATIONS",
    detail: [
      {
        title: "SOFTWARE ENGINEER -- FRONT END APPLICATIONS",
        year: "2020 - present",
    ...
    detail: [
      {
        ...
        year: "2019 - 2020",
        description:
          "Reporting to the VP Engineering & Product, promoted to oversee local and remote team of 4 front end engineers during a period of extensive internal change, focusing on both building and maintaining NobleHour and Collaboratory SaaS and mobile products, as well as mentoring and coaching staff. Worked toward getting a VPAT for Collaboratory, to provide a determination of accessibility compliance.",
      },
      {
        title: "FRONT END ENGINEER",
        year: "2017 - 2019",
